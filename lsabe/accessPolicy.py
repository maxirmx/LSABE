...
#  For testing simplicty I assume that A(0,j) = 1, A(i,j)=0 if i!=1  for any j
...
# A helper for lsabe.encrypt
# For each i∈[l], we let λi denote Ai·v, where Ai is row i of A 
...
#  w - a set of constants {wi∈Zp} i∈N with Σ[w(i)*A(i)] = (1,0,...,0).
    def w(self, i):
        if i == 0:
            return 1
        return 0
